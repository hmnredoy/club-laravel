...
Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="media">
                                        <a class="pull-left" href="#">
                                            <img class="media-object img-circle img-comments" src="{{asset('assets/img/user.png')}}" />
                                        </a>
                                        <div class="media-body">
      ...
      <!-- Nested media object -->
                                            <div class="media">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object img-circle img-comments" src="{{asset('assets/img/user.gif')}}" />
                                                </a>
                                                <div class="media-body">
